...
def main():
    ...
    parser.add_argument('-fl', '--minimum-fan-duty-cycle', type=float, default=FAN_MIN, help='Minimum duty cycle of the fan (usually 20% -> 0.2)')
    parser.add_argument('-fu', '--maximum-fan-duty-cycle', type=float, default=FAN_MAX, help='Maximum duty cycle of the fan (100% -> 1.0)')
